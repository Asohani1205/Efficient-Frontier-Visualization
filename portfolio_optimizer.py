...
if __name__ == "__main__": 
    ...
    df, df_normalised_return, df_log_daily_return = nb_allindex.read_csv_and_generate_df('C:/Users/Atharva/Desktop/sample_project_1/efficient_frontier/NIFTYBANK Portfolio Optimization/Portfolio-Optimization-and-Efficient-Frontier/data/nifty_bank_df_2018-4-2_to_2020-5-22.csv', 'Date')
    ...
    df, df_normalised_return, df_log_daily_return = nb_select_stocks.read_csv_and_generate_df('C:/Users/Atharva/Desktop/sample_project_1/efficient_frontier/NIFTYBANK Portfolio Optimization/Portfolio-Optimization-and-Efficient-Frontier/data/nifty_bank_df_2018-4-2_to_2020-5-22.csv', 'Date', ['HDFCBANK Adjusted Close','ICICIBANK Adjusted Close','INDUSINDBK Adjusted Close','KOTAKBANK Adjusted Close','SBIN Adjusted Close'])
